...
RUN pip install django==1.11 pylint-django django-jenkins pdoc codecov pytest-django pytest-cov mixer selenium pylint black bandit pyflakes nose coverage
